...
[![Stars](https://img.shields.io/github/stars/Ronix-Execute-Update-v4.1?style=flat-square)](https://github.com)
...
git clone https://github.com/Ronix-Execute-Update-v4.1.git
cd Ronix-Execute-Update-v4.1
